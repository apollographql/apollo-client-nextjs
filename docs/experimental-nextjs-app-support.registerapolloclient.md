...
[Home](./index.md) &gt; [@apollo/experimental-nextjs-app-support](./experimental-nextjs-app-support.md) &gt; [registerApolloClient](./experimental-nextjs-app-support.registerapolloclient.md)
