...
[Home](./index.md) &gt; [@apollo/experimental-nextjs-app-support](./experimental-nextjs-app-support.md) &gt; [DebounceMultipartResponsesLink](./experimental-nextjs-app-support.debouncemultipartresponseslink.md)
...
|  --- | --- | --- |
|  [(constructor)(config)](./experimental-nextjs-app-support.debouncemultipartresponseslink._constructor_.md) |  | Constructs a new instance of the <code>AccumulateMultipartResponsesLink</code> class |

## Methods

|  Method | Modifiers | Description |
|  --- | --- | --- |
|  [request(operation, forward)](./experimental-nextjs-app-support.debouncemultipartresponseslink.request.md) |  |  |
